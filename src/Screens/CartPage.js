...
const GLOBAL = require('../Global');
            ...
            <View>
              <View style={styles.totalView}>
                ...
                <View style={styles.checkoutView}>
                 <Text style={styles.checkout} onPress={()=>{this.orderplaced()}}>Checkout</Text>
                </View>
            </View>
            :null} 
        </View>
  ...
  Quantity:{
    ...
    displayViewbox:{flexDirection:'row',height:120,marginTop:10,backgroundColor:'white', borderWidth:1,borderColor: '#ddd'}
  });
